            ...
            <div class="row mb-2">
                <div class="col-sm-10">
                    <div class="text-center">
                        ...
                        <h1 class="m-0  text-primary text-uppercase">  Tarification des actes</h1>
                    </div>
                ...
                <div class="d-flex justify-content-center">
                    <div class="w-75">
                        <div class="d-flex justify-content-between">
                            <h4><i class="fas fa-list"></i> {{$isTrashed==false?'LISTE DES ACTES':'LISTE DES ACTES DANS LA CORBEILLE';}}</h4>
                            ...
                            <table class="table table-striped table-sm">
                                ...
                                <tbody>
                                    @foreach ($actes as $index => $acte)
                                        <tr>
                                            <td>{{$index+1}}</td>
                                            <td>{{$acte->abreviation=="Aucune"?$acte->name:$acte->abreviation}}</td>
                                            ...
                                            <td class="text-center">
                                                <button data-toggle="modal" data-target="#formTarification"
                                                    wire:click.prevent='edit({{$acte}})' class="btn btn-link btn-sm"
                                                    type="button"><i class="fas fa-edit    "></i>
                                                </button>
                                                <button wire:click.prevent='showDeleteDialog({{$acte}})'
