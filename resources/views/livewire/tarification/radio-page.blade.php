                    ...
                    <div class="w-75">
                        <div class="d-flex justify-content-between">
                            <h4><i class="fas fa-list"></i>
                                {{$isTrashed==false?'LISTE DES EXAMENS DES RADIO':'LISTE DES EXAMENS DES RADIO DANS LA CORBEILLE';}}
                            </h4>
                            ...
                            <table class="table table-striped table-sm">
                                ...
                                <tbody>
                                    @foreach ($radios as $index => $radio)
                                        <tr>
                                            <td>{{$index+1}}</td>
                                            <td>{{$radio->abreviation=="Aucune"?$radio->name:$radio->abreviation}}</td>
                                            ...
                                            <td class="text-center">
                                                <button data-toggle="modal" data-target="#formTarification"
                                                    wire:click.prevent='edit({{$radio}})' class="btn btn-link btn-sm"
                                                    type="button"><i class="fas fa-edit    "></i>
                                                </button>
                                                <button wire:click.prevent='showDeleteDialog({{$radio}})'
