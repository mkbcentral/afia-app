            ...
            <div class="row mb-2">
                <div class="col-sm-10">
                    <div class="text-center">
                        ...
                        <h1 class="m-0  text-primary text-uppercase">  Tarification echographie</h1>
                    </div>
                    ...
                    <div class="w-75">
                        <div class="d-flex justify-content-between">
                            <h4><i class="fas fa-list"></i>
                                {{$isTrashed==false?'LISTE DES EXAMENS ECHOGRAPHIE':'LISTE DES EXAMENS ECHOGRAPHIE DANS LA CORBEILLE';}}
                            </h4>
