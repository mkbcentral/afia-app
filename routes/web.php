...
use App\Http\Livewire\Facturation\Prive\CreateFactureprivePage;
...
Route::get('create-facture-prive/{facture}',CreateFactureprivePage::class)->name('facturation.prive.create');
